...
type GetDolarPriceHandlerFunc func(GetDolarPriceParams) middleware.Responder

// Handle executing the request and returning a response
func (fn GetDolarPriceHandlerFunc) Handle(params GetDolarPriceParams) middleware.Responder {
	return fn(params)
}

// GetDolarPriceHandler interface for that can handle valid get dolar price params
type GetDolarPriceHandler interface {
	Handle(GetDolarPriceParams) middleware.Responder
}
